...
export default async function Get ( req: NextApiRequest, res: NextApiResponse ) {
	...
	if ( req.method === 'POST' ) {
		...
		formdata.append(
			...
			}</paisOrigem>\n   <obs>Configuração da caixas:\n Adesivo Frágil nas Laterais: ${ getClinet.data.adFrailLat
			},\n Adesivo Frágil nas Cabeceiras: ${ getClinet.data.adFrailCab
			},\n Adesivo Especial nas Laterais: ${ getClinet.data.adEspecialLat
			},\n Adesivo Especial nas Cabeceiras: ${ getClinet.data.adEspecialCab
			},\n Laterais por fora das Cabeceiras: ${ getClinet.data.latFCab
			},\n Cabeceiras até o chão: ${ getClinet.data.cabChao
			},\n Cabeceiras até o topo: ${ getClinet.data.cabTop
			},\n Caixa econômica: ${ getClinet.data.cxEco },\n Caixa estrturada: ${ getClinet.data.cxEst
			},\n Caixa leve: ${ getClinet.data.cxLev },\n Caixa Reforçada: ${ getClinet.data.cxRef
			},\n Caixa Super Reforçada: ${ getClinet.data.cxSupRef
			},\n Paletes sob medida: ${ getClinet.data.platSMed
			},\n Caixa Resistente: ${ getClinet.data.cxResi },\n Engradado econômico: ${ getClinet.data.engEco
			},\n Engradado leve: ${ getClinet.data.engLev },\n Engradado reforçado: ${ getClinet.data.engRef
